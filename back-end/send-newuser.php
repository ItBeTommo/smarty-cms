...
// Generate Activation Code
    ...
    $createAccount = "INSERT INTO users (`firstname`, `lastname`, `email`, `password`, `activation`) VALUES ('$firstName', '$lastName', '$email', '$password', 'activated')";
    ...
    $message = "An account has been made for you at Smarty CMS \n\n";
    $message .= "Username: $email - Password $emailPass";
    if(mail($email, 'New Account at Smarty Creative', $message, 'From:'.'noreply@smarty-creative.com')) {
        echo '<div class="alert alert-success">New user account has been added succesfully and login info has been sent to the user.</div>';
    } else {
        echo '<div class="alert alert-danger">There was an error sending email.</div>';
    }
