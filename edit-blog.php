    ...
    <div id="page-content-wrapper">
      ...
      <!-- Begin Page Content -->
        ...
        <nav aria-label="breadcrumb">
         ...
         <div class="d-flex">
            <div>
                <h1 class="h3 mb-1 text-gray-800">Editing Blog</h1>
                <p class="mb-4"></p>
            </div>
            <div class="ml-auto">
            ...
            <form method="post" id="create-blog">
              <div class="row">
                <div class="col">
                    ...
                    <input type="text" class="form-control" placeholder="Blog Title" name="title" id="PageTitle" value="<?php echo $title; ?>">
                </div>
                <div class="col">
                   <label for="type">Blog Type.</label>
                    <select class="form-control" id="type" name="type">
                      ...
                      <option value="Site Updates">Updates</option>
                    </select>
                </div>
              </div><br />
                <input type="hidden" id="postedBy" name="author" value="<?php echo $author; ?>">
                <input type="hidden" id="date" name="dateInput" value="<?php echo $date; ?>">
                <input type="hidden" id="blogid" name="blogid" value="<?php echo $blogid; ?>">
                <label for="content">Blog Content</label>

                    <textarea class="form-control" id="content" name="contentbox"><?php echo $content; ?></textarea>
                <br />
              <div class="row">
...
$("#create-blog").submit(function(event){
    ...
    $.ajax({
        type: "POST",
        url: "back-end/send-editblog.php",
        data: postedData,
        ...
        error: function() {
            $("#blog-msg").html("<div class='alert alert-danger'>There was an error with the Ajax Call. Try again later.</div>");
        }
    });
