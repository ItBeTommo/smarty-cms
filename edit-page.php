    ...
    <div id="page-content-wrapper">
      ...
      <!-- Begin Page Content -->
        ...
        <nav aria-label="breadcrumb">
         ...
         <div class="d-flex">
            <div>
                <h1 class="h3 mb-1 text-gray-800">Editing Page</h1>
                <p class="mb-4"></p>
            </div>
            <div class="ml-auto">
            ...
            <form method="post" id="create-page">
              <div class="row">
                <div class="col">
                    ...
                    <input type="text" class="form-control" placeholder="Page Title" name="title" id="PageTitle" value="<?php echo $title; ?>">
                </div>
                <div class="col">
...
$("#create-page").submit(function(event){
    ...
    $.ajax({
        type: "POST",
        url: "back-end/send-editpage.php",
        data: postedData,
