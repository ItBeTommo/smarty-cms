    ...
    <div id="page-content-wrapper">
      ...
      <!-- Begin Page Content -->
        ...
        <nav aria-label="breadcrumb">
         ...
         <div class="d-flex">
            <div>
                <h1 class="h3 mb-1 text-gray-800">Page Manager</h1>
                <p class="mb-4">From this page you can Create New pages or modify existing ones.</p>
            </div>
            <div class="ml-auto">
                <a href="createpage.php" class="btn btn-success">New Page <span class="oi oi-plus" title="New Page" aria-hidden="true"></span></a> 
            </div> 
         </div>
            ...
            <table class="table table-striped table-hover">
                  ...
                  <tbody>
                       ...
                       <?php
                        $sql = "SELECT * FROM pages LIMIT 50";
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                $shortContent = strip_tags(substr($content,0,50));
                                    echo '<tr> 
                                            ...
                                            <td>'.$shortContent.'</td> 
                                            <td>'.$commenting.'</td> 
                                            <td><a href="edit-page.php?id='.$pageid.'"><span class="oi oi-pencil" title="edit" aria-hidden="true" style="color: #f4b623"></span></a> &nbsp; &nbsp; <a href="back-end/delete-page.php?id='.$pageid.'" id="del-page"><span class="oi oi-x" title="Delete" aria-hidden="true" style="color: #b80303"></span></a></td>
                                          </tr>';
