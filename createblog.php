    ...
    <div id="page-content-wrapper">
      ...
      <!-- Begin Page Content -->
        ...
        <nav aria-label="breadcrumb">
         ...
         <div class="d-flex">
            <div>
                <h1 class="h3 mb-1 text-gray-800">Create New Blog</h1>
                <p class="mb-4">Add a new blog.</p>
            </div>
            <div class="ml-auto">
            ...
            <form method="post" id="create-blog">
              <div class="row">
                <div class="col">
                    ...
                    <input type="text" class="form-control" placeholder="Blog Title" name="title" id="PageTitle">
                </div>
                <div class="col">
              ...
              <div class="row">
                ...
                <div class="col">
                    <div class="float-right">
                        <input id="submitButton" type="submit" class="btn btn-success" name="submit" value="Create Blog">
                    </div>
                </div>
              </div>
            </form>
